...
What does SpaceX's IPO look like, how is it funded, and where does it touch the AI capital web?
...
|---|---:|---:|---:|
| Revenue | — | $18.7B (+33%) | $4.7B |
| Net profit / (loss) | +$791M | **($4.9B)** | ($4.3B) |

2025 spend was **$20.7B**, of which **$12.7B went to AI**, $4.2B to Starlink, $3.8B to other space ventures — i.e., the losses are largely an **AI-investment** choice ([source](/external-sources/spacex-ipo-s1-filing.md)).

## Starlink — the cash engine

| Starlink (2025) | Value |
|---|---:|
| Revenue | $11.4B (~61% of SpaceX total) |
| Operating profit | $4.4B (only consistently GAAP-profitable segment) |
| Subscribers | ~5M (Feb 2026) → ~10M shortly after |
| ARPU | ~$81/month (down ~18%) |

Analysts estimate Starlink is **~40–55% of the IPO valuation** despite **~65–80% of current revenue** — the gap is investors paying for speculative futures (Starship, xAI, orbital AI data centers) ([source](/external-sources/spacex-ipo-s1-filing.md)).

## xAI merger & the AI tie-in

In **February 2026**, SpaceX merged with **xAI**, pitching a combined "space and AI powerhouse" and a claimed **$28.5T** total addressable market. The concrete link to the AI web: **Anthropic's Series H names SpaceX as a compute partner**, providing GPU capacity in xAI's **Colossus 1 & 2** data centers ([Anthropic Series H](/external-sources/anthropic-series-h-65b.md)). So post-merger, SpaceX is both an AI *spender* (its own $12.7B) and an AI *compute supplier* (to Anthropic).
